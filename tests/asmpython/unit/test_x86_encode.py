...
from asmpython.backends.x86_64.encode import Encoded, encode_line
...
class TestBranchesResolveWithinAFunction:
    ...
    def test_a_backward_jump_reaches_its_label(self):
        ...
        for line in (".Ltop:", "nopq", "jmp .Ltop"):
            if line == "nopq":
                ...
                continue
            encode_line(line, out)
        from asmpython.backends.x86_64.encode import resolve
        resolve(out)
    ...
    def test_an_unknown_label_is_refused(self):
        from asmpython.backends.x86_64.encode import EncodeError, resolve
        out = Encoded()
...
class TestWhatItCannotEncodeItRefuses:
    ...
    def test_a_general_move_naming_an_sse_register_is_refused(self):
        ...
        """
        from asmpython.backends.x86_64.encode import EncodeError
        out = Encoded()

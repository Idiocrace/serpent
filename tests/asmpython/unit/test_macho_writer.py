...
from asmpython.backend.objfile.macho import (
...
def _x86_object():
    from asmpython.backends.x86_64.encode import encode_function
    from asmpython.backends.x86_64.machoemit import _translate
...
def _arm_object():
    from asmpython.backends.arm64.encode import encode_function
    from asmpython.backends.arm64.machoemit import _translate
...
class TestTheTranslationsFromElf:
    ...
    def test_a_call_and_a_data_reference_are_different_on_x86(self):
        ...
        from asmpython.backends.x86_64.encode import (
            R_X86_64_PC32, R_X86_64_PLT32)
        from asmpython.backends.x86_64.machoemit import (
    ...
    def test_the_implicit_minus_four_is_removed_on_x86(self):
        from asmpython.backends.x86_64.encode import R_X86_64_PLT32
        from asmpython.backends.x86_64.machoemit import _translate
    ...
    def test_aarch64_needs_no_addend_arithmetic(self):
        ...
        from asmpython.backends.arm64.encode import (
            R_AARCH64_ADD_ABS_LO12_NC, R_AARCH64_ADR_PREL_PG_HI21)
        from asmpython.backends.arm64.machoemit import (
    ...
    def test_an_aarch64_addend_is_refused_rather_than_dropped(self):
        ...
        from asmpython.backends.arm64.encode import R_AARCH64_CALL26
        from asmpython.backends.arm64.machoemit import _translate
    ...
    def test_an_unknown_relocation_is_refused(self, module):
        ...
        emit = importlib.import_module(
            f"asmpython.backends.{'x86_64' if module == 'x86_64' else 'arm64'}"
            f".machoemit")

...
`src/asmpython/runtime/tasks.py`) wraps a coroutine as "a generator with a
...
is still visible inside (the copy inherits it) -- and asmpython's version of
...
under asmpython. It is refused BY NAME rather than silently mismeasured:
